# MyChain - 基于Cosmos思想的区块链项目

一个基于Cosmos SDK思想实现的简化版区块链，支持挖矿、转账等基础功能，使用Koa2构建API服务器，包含完整的前端管理界面。
...
- ✅ **交易系统**: 发送/接收交易、交易签名验证
- ✅ **挖矿机制**: 可调难度的挖矿系统
- ✅ **数据完整性**: Merkle树验证、区块链完整性检查

### API功能
- 🔗 **区块链API**: 查询区块、验证链、获取统计信息
- 💰 **钱包API**: 创建钱包、查询余额、发送交易
- ⛏️ **挖矿API**: 开始挖矿、查询状态、矿工统计
...
### 区块链参数
- **挖矿难度**: 默认为2，可在`blockchain.js`中修改
- **出块时间**: 目标10秒，可调整
- **挖矿奖励**: 默认100 MYC
- **最大交易数**: 每个区块无限制
...
这个project使用 MIT 许可证 - 查看 [LICENSE](LICENSE) 文件了解详情

## 🙏 致谢

- [Cosmos SDK](https://docs.cosmos.network/) - 区块链框架灵感来源
- [Koa.js](https://koajs.com/) - 轻量级Node.js框架
